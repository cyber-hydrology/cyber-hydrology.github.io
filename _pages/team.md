...
## Alumni Members
<div style="background-color: #e8eaf6;"> <!-- Adds a distinct background color -->
  <h2 style="padding-left: 15px;">Alumni Members</h2>
  {% assign number_printed = 0 %}
  ...
  <div class="col-sm-6 clearfix" style="background-color: #f0f0f0; padding: 20px;">
